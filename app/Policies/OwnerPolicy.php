...
class OwnerPolicy
{
    ...
    { 
        return $user->hasAnyRole(['Administrador', 'Gerente']) || $user->hasPermissionTo('Ver Propietarios'); 
    }
    
    public function view(User $user, Owner $owner): bool 
    { 
        return $user->hasAnyRole(['Administrador', 'Gerente']) || $user->hasPermissionTo('Ver Detalle Propietarios'); 
    }
