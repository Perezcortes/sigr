                ...
                Forms\Components\Tabs::make('AdministracionTabs')
                    ...
                    ->tabs([
                        ...
                        Forms\Components\Tabs\Tab::make('Configuración')
                            ...
                            ->schema([
                                Forms\Components\Livewire::make(SettingsManager::class, ['rentId' => $this->record->id])
                        ...
                        Forms\Components\Tabs\Tab::make('Reportes de pago')
                            ...
                            ->schema([
                                Forms\Components\Livewire::make(PaymentManager::class, ['rentId' => $this->record->id])
                        ...
                        Forms\Components\Tabs\Tab::make('Mantenimiento')
                            ...
                            ->schema([
                                Forms\Components\Livewire::make(MaintenanceManager::class, ['rentId' => $this->record->id])
                        ...
                        Forms\Components\Tabs\Tab::make('Mensajes')
                            ...
                            ->badgeColor('warning')
                            ->schema([
                                Forms\Components\Livewire::make(ChatManager::class, ['rentId' => $this->record->id])
