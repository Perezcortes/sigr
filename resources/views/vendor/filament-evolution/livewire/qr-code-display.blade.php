<div x-data="{
    ...
    @elseif($error)
        <div class="flex flex-col items-center justify-center py-12">
            ...
            <button type="button" wire:click.prevent="fetchQrCode"
    ...
    @elseif($qrCode)
        <div class="flex flex-col items-center">
            ...
            <button type="button" wire:click.prevent="refreshQrCode" wire:loading.attr="disabled"
    ...
    @else
        <div class="flex flex-col items-center justify-center py-12">
            <button type="button" wire:click.prevent="fetchQrCode" wire:loading.attr="disabled"
