<div wire:poll.4s.visible class="flex flex-col h-[600px] bg-[#e5ddd5] dark:bg-[#0b141a] border border-gray-200 rounded-xl shadow-2xl dark:border-gray-700 overflow-hidden relative">
